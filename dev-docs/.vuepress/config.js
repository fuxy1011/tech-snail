      ...
      "/react/": [
        {
          title: "React",
          collapsable: false,
          children: ["/react/lifecycle.md", "/react/databind.md"],
        },
      ],
      "/tech-world/": [
        {
      ...
      "/toolkit/": [
        {
          title: "工具箱",
          collapsable: false,
          children: ["", "/toolkit/base-memory.md"],
        },
      ],
      "/read-books/": [
        {
          title: "读书",
          collapsable: false,
          children: ["", "/read-books/what-life-should-mean-to-you.md"],
        },
      ],
      "/study/": [
        {
